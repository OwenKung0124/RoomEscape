...
public class SettingWorld extends World
{
    ...
    private StartButton resumeButton;
    ...
    public SettingWorld(GameData data){
        ...
        newGameButton = new StartButton("setting/start.png", StartButton.MODE_NEW_GAME);
        resumeButton  = new StartButton("setting/resume.png", StartButton.MODE_RESUME);

        addObject(newGameButton, GameConfig.WORLD_W / 2, 635);
        addObject(resumeButton,  GameConfig.WORLD_W / 2 + 260, 635);
    ...
    /**
     * Called by start button to start a new game.
     */
