...
public abstract class PlayerNew extends CombatActor
{
    ...
    private boolean[] ownedArtifacts = new boolean[10];
    ...
    public boolean hasArtifact(int name){//check if artifact is owned
        return ownedArtifacts[name];
    }
    
    public void setArtifactOwned(int name){//if artifact bought the artifact is owned
