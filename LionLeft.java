...
/**
 * LionLeft is a statue in the room added using room tile configuration
 * It is a solid blocker
 *
 * Use Decoration class to display the actual graphics
 */
public class LionLeft extends Blocker
{
    ...
    protected void addedToWorld(World world)
    {
        ...
        visual=new Decoration(GameConfig.LION_LEFT_IMG, GameConfig.LION_LEFT_W, GameConfig.LION_LEFT_H);
